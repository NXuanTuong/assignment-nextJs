                ...
                {products.map((item: any, index: any) => (
                  ...
                  >
                    <div className="relative overflow-hidden">
                      ...
                      <div className="hover:bg-red-500 btn_add_cart cursor-pointer top-[80%] left-[28%] delay-150 duration-200 ease-in-out py-1 px-3 rounded-md text-red-500 hover:text-white border border-red-400 font-semibold uppercase absolute">
                        <button>
                          Add to Cart{" "}
                          <span>
