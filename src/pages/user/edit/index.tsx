              ...
              <div className="w-full md:w-9/12 mx-2 h-64">
                  <div className="bg-white p-3 shadow-sm rounded-sm">
                      ...
                      <div className="text-gray-700">
                        <form action="" id='form-edit-user' onSubmit={handleSubmit(onSubmit)}>
                        <div className="grid md:grid-rows-4 text-sm">
                              <div className="grid grid-cols-2 items-center" style={{ gridTemplateColumns: "1fr 7fr" }}>
                                  <div className="px-4 py-2 font-semibold  ">Name</div>
                                  <div className="px-4 py-2">
                                    <input type="text"
                                    className="p-3 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 py-2 block w-full sm:text-sm border border-green-600 "
                              ...
                              <div className=''>
                                <button type="submit" className="float-right mt-[25px] text-gray-900 bg-gradient-to-r from-teal-200 to-lime-200 hover:bg-gradient-to-l hover:from-teal-200 hover:to-lime-200 focus:ring-4 focus:outline-none focus:ring-lime-200 dark:focus:sring-teal-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Cập nhật thông tin</button>
                              </div>
                          </div>
                        </form>
